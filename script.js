    ...
    req2.onreadystatechange = function(){
        if(req2.readyState==4){
            ...
            for(let i = 0; i < 1; i++){
                destaques.innerHTML += `
                <div class="mySlides">
                    <iframe width="480" height="300" src="${resposta.results[i].data[480]}" title="GTA" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <div>
